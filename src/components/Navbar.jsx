      ...
      <AnimatePresence mode="wait">
        {!hasScrolled ? (
          <motion.header
            ...
            className="fixed left-4 right-4 top-4 z-50 md:left-6 md:right-auto md:w-[min(96vw,72rem)] lg:left-20"
          >
            <div
              className={`relative flex flex-col gap-4 rounded-[1.9rem] border border-white/10 bg-[rgba(15,10,31,0.82)] px-4 py-3 shadow-[0_24px_70px_rgba(0,0,0,0.34)] backdrop-blur-2xl transition-colors duration-300 sm:flex-row sm:items-center sm:px-5 lg:px-6 lg:pr-8 ${hasScrolled ? 'border-white/12 bg-[rgba(15,10,31,0.58)]' : ''}`}
            >
              <a
                href="#home"
      ...
      <AnimatePresence>
        {hasScrolled ? (
          <motion.button
            ...
            className="fixed right-4 top-4 z-[100] flex touch-manipulation items-center gap-2 rounded-full border border-white/15 bg-[rgba(22,12,42,0.96)] px-4 py-3 text-sm font-semibold text-white shadow-[0_20px_60px_rgba(0,0,0,0.38)] transition duration-300 hover:-translate-y-0.5 hover:border-roseglow-300/40 md:right-6 lg:right-20"
            aria-expanded={open}
        ...
        {open && hasScrolled && (
          <>
            <motion.div
              ...
              className="fixed inset-0 z-[90] bg-[#090512]/60"
              aria-hidden="true"
            ...
            <motion.aside
              ...
              transition={{ duration: 0.25, ease: 'easeOut' }}
              className="fixed left-4 right-4 top-[4.75rem] z-[100] mx-auto w-full max-w-[20rem] md:left-auto md:right-6 md:top-20 lg:right-20"
            >
